...
const bridge=await import(pathToFileURL(`${root}/js/gg-bridge.js`));
test('Bowling v1.9 bridge parses a localhost-only v1 token and normalizes MILA route',async()=>{
...
test('Bowling v1.9 loads bridge before routing and controller publishes after real join',()=>{
...
test('immutable Bowling v1.8 has no GG bridge edits',()=>{
